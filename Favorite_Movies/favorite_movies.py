...
dragon = Movie('How to Train Your Dragon', 'Vikings and dragons learn to co-exist!', 'https://images-na.ssl-images-amazon.com/images/I/91DnBoRk-WL._SL1500_.jpg', 'https://www.youtube.com/watch?v=oKiYuIsPxYk')  # noqa
panda = Movie('Kung Fu Panda', 'A panda discovers the power within an saves the world', 'http://chevaliertheatre.com/wp-content/uploads/kung.jpg', 'https://www.youtube.com/watch?v=PXi3Mv6KMzY')  # noqa
star_wars = Movie('Star Wars', 'A story of Jedi taking down the empire', 'https://upload.wikimedia.org/wikipedia/en/b/b2/ReturnOfTheJediPoster1983.jpg', 'https://www.youtube.com/watch?v=5UfA_aKBGMc')  # noqa
